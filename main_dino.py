...
def get_args_parser():
    ...
    parser.add_argument('--pretrained', default=False, type=bool,
        help="""If should load pre-trained version of the architecture.""")
...
def train_dino(args):
    ...
    # ============ preparing data ... ============
    # replaced with DINOCXR data augmentation protocol
    ...
    if args.optimizer == "adam":
        optimizer = torch.optim.Adam(params_groups)  # to use with convnets
